...
rects1 = ax15.bar(np.arange(3),(NotHungryMenRobin,LittleHungryMenRobin,VeryHungryMenRobin), width, color='r')
rects2 = ax15.bar(np.arange(3)+width,(NotHungryWomenRobin,LittleHungryWomenRobin,VeryHungryWomenRobin), width, color='b')
